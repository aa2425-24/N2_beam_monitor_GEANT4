...
//G4Random::setTheSeed(seed);
  ...
  G4cout << "seed from before the ui " << G4Random::getTheSeed() << G4endl;
...
G4cout << "seed from after the ui " << G4Random::getTheSeed() << G4endl;
  ...
  auto* runManager =
    ...
    G4cout << "seed from after the RM " << G4Random::getTheSeed() << G4endl;
